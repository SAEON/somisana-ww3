...
CONFIG_DIR=/home/gfearon/lustre/somisana-ww3/configs/sa_west_02_derefined
export RUN_DIR=$CONFIG_DIR/RUN_02
export GRID_DIR=$CONFIG_DIR/GRID/
export BRY_DIR=$CONFIG_DIR/SPEC_CMEMS/
export SRF_DIR=/home/gfearon/lustre/somisana-croco/DATASETS_CROCOTOOLS/ERA5/eez_for_croco
